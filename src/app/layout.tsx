...
export const metadata: Metadata = {
  ...
  description:
    "Vladyslav Hutsu Portfolio using Next.js. Full Stack Developer Ready !! ",
  icons: {
    icon: '/profile.png',
  },
  creator: 'Vladyslav Hutsu',
  keywords: 'Portfolio, Full Stack, Development, Freelance, Vladyslav, Amano, Frontend, Backend, Design, Web3, Crypto',
  abstract: 'Vladyslav Hutsu Portfolio',
  applicationName: 'Topsi',
  openGraph: {
    type: "website",
    images: [
      {
    ...
    url:"https://Vladyslav.vercel.app"
  }
};
